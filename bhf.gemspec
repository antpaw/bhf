...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "publicbhf/ajax_loader.gif",
    "publicbhf/bg.png",
    "publicbhf/mooeditable-toolbarbuttons-tango.png",
    "publicbhf/pictos.png",
    "publicbhf/small_ajax_loader.gif",
    "publicbhf/small_ajax_loader_h.gif",
    "publicbhf/wmd-buttons.png",
    "publiclogo_bhf.png",
